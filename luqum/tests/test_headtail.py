...
class HeadTailLexerTestCase(TestCase):
    ...
    def test_simple_token_tail(self):
        ...
        self.handle(b)
        self.handle(create_token("SEPARATOR", "\r", 4))
        self.handle(c)
...
class HeadTailManagerTestCase(TestCase):
    ...
    def test_pos_none(self):
        p = [Item(), Item(pos=None)]
        self.headtail.pos(p)
        self.assertEqual(p[0].pos, None)

    def test_simple_term(self):
        p = [Item(), Item(pos=4, head="\t", tail="\r")]
    ...
    def test_unary(self):
        p = [Item(), Item(head="\t", tail="\r", pos=3), Item(head="\n", tail="  ", pos=5)]
    ...
    def test_range(self):
        p = [
            ...
            Item(head="\n", tail="  ", pos=5),  # expr1
            Item(head="\n\n", tail="\t\t", pos=7),  # TO
            Item(head="\r\r", tail=" \t ", pos=9),  # expr2
            Item(head=" \r ", tail=" \n ", pos=12),  # ]
        ]
